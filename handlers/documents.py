...
class PDF:
    ...
    def addPageAfter(self, input_path2, pageIndex):
        ...
        for page in range(file2.getNumPages()):
            print("page " + str(page) + " of " + str(file2.getNumPages()))
            output.addPage(file2.getPage(page))
    ...
    def set_toc(self,toc):
        ...
        hl, title, pn = toc.split()
        hl = int(hl)
        pn = int(pn)
        self.toc.append([hl, title, pn])
